...
function App() {
  ...
  const calc = (t) => {
    ...
    const cur = (sched == null ? void 0 : sched.currency) || "USD";
  ...
  const CurAmount = ({ field, onChange }) => /* @__PURE__ */ React.createElement("div", { className: "flex gap-1" }, /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "text",
      inputMode: "decimal",
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "min-h-screen bg-slate-100 text-slate-800 p-4 md:p-6", style: { fontFamily: "'Pretendard', system-ui, sans-serif" } }, /* @__PURE__ */ React.createElement("div", { className: "max-w-full mx-auto" }, /* @__PURE__ */ React.createElement("header", { className: "mb-4" }, /* @__PURE__ */ React.createElement("h1", { className: "text-xl md:text-2xl font-bold text-slate-900" }, "\uCD9C\uC7A5\uBE44 \uACC4\uC0B0\uAE30"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-slate-500 mt-1" }, "\uC5EC\uBE44\uADDC\uC815 2024.07.01 \uAE30\uC900 \xB7 \uCD9C\uC7A5 1\uAC74\uC5D0 \uCD9C\uC7A5\uC790 \uC5EC\uB7EC \uBA85\uC744 \uB123\uACE0 \uACC4\uC0B0\xB7\uC800\uC7A5\uD558\uC138\uC694")), /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-xl border border-slate-200 p-4 mb-4 shadow-sm" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap items-center gap-x-6 gap-y-2" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2" }, /* @__PURE__ */ React.createElement("span", { className: "text-sm font-semibold text-slate-700" }, "\uC624\uB298\uC790 \uD658\uC728"), status === "loading" && /* @__PURE__ */ React.createElement("span", { className: "text-xs text-slate-400" }, "\uBD88\uB7EC\uC624\uB294 \uC911\u2026"), status === "ok" && /* @__PURE__ */ React.createElement("span", { className: "text-[11px] px-2 py-0.5 rounded-full bg-emerald-50 text-emerald-700 border border-emerald-200" }, "\uC790\uB3D9 \uC870\uD68C\uB428"), status === "error" && /* @__PURE__ */ React.createElement("span", { className: "text-[11px] px-2 py-0.5 rounded-full bg-amber-50 text-amber-700 border border-amber-200" }, "\uC790\uB3D9 \uC870\uD68C \uC2E4\uD328 \xB7 \uC218\uB3D9 \uC785\uB825")), /* @__PURE__ */ React.createElement("div", { className: "text-sm" }, /* @__PURE__ */ React.createElement("span", { className: "text-slate-500" }, "USD\u2192KRW "), /* @__PURE__ */ React.createElement("span", { className: "font-semibold tabular-nums" }, usdKRW ? usdKRW.toLocaleString("ko-KR", { maximumFractionDigits: 2 }) : "-")), /* @__PURE__ */ React.createElement("div", { className: "text-sm" }, /* @__PURE__ */ React.createElement("span", { className: "text-slate-500" }, "JPY\u2192KRW "), /* @__PURE__ */ React.createElement("span", { className: "font-semibold tabular-nums" }, jpyKRW ? jpyKRW.toLocaleString("ko-KR", { maximumFractionDigits: 4 }) : "-")), updatedAt && /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-slate-400" }, "\uAE30\uC900: ", updatedAt), /* @__PURE__ */ React.createElement("button", { onClick: fetchRates, className: "text-xs px-3 py-1.5 rounded-md border border-slate-300 hover:bg-slate-50 transition" }, "\uD658\uC728 \uC0C8\uB85C\uACE0\uCE68")), status === "error" && /* @__PURE__ */ React.createElement("div", { className: "mt-3 flex flex-wrap gap-4 items-end border-t border-slate-100 pt-3" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: label }, "USD 1\uB2EC\uB7EC = ? \uC6D0"), /* @__PURE__ */ React.createElement("input", { className: inp + " " + money + " w-32", placeholder: "\uC608: 1380", value: manual.USD, onChange: (e) => setManual((m) => ({ ...m, USD: e.target.value })) })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: label }, "JPY 1\uC5D4 = ? \uC6D0"), /* @__PURE__ */ React.createElement("input", { className: inp + " " + money + " w-32", placeholder: "\uC608: 9.1", value: manual.JPY, onChange: (e) => setManual((m) => ({ ...m, JPY: e.target.value })) })), /* @__PURE__ */ React.createElement("p", { className: "text-[11px] text-slate-400 max-w-xs" }, "\uAE30\uD0C0 \uD1B5\uD654 \uD658\uC0B0\uC5D0\uB294 \uC790\uB3D9 \uD658\uC728\uC774 \uD544\uC694\uD569\uB2C8\uB2E4. \uB124\uD2B8\uC6CC\uD06C \uBCF5\uAD6C \uD6C4 \uC0C8\uB85C\uACE0\uCE68\uD558\uC138\uC694."))), /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-xl border border-slate-200 p-4 mb-4 shadow-sm flex flex-wrap items-center gap-3" }, /* @__PURE__ */ React.createElement("label", { className: "text-sm font-semibold text-slate-700 whitespace-nowrap" }, "\uCD9C\uC7A5\uBA85"), /* @__PURE__ */ React.createElement("input", { className: inp + " max-w-md", placeholder: "\uC608: Bio Asia Taiwan 2026 \uCD9C\uC7A5", value: tripName, onChange: (e) => setTripName(e.target.value) }), /* @__PURE__ */ React.createElement("span", { className: "text-xs text-slate-400" }, "\uCD9C\uC7A5\uC790 ", travelers.length, "\uBA85")), /* @__PURE__ */ React.createElement("div", { className: "flex gap-4 overflow-x-auto pb-4" }, results.map(({ t, r }, idx) => {
    var _a, _b;
