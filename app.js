...
function CurAmount({ field, onChange, inpClass, showBuffer }) {
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "flex gap-1" }, /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "text",
      inputMode: "decimal",
  ...
  )), showBuffer && /* @__PURE__ */ React.createElement("label", { className: "mt-1 flex items-center gap-1.5 text-[11px] text-slate-600 cursor-pointer" }, /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "checkbox",
